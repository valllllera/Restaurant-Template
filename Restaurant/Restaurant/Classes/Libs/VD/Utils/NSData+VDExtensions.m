...
@implementation NSData (VDExtensions)
...
- (NSString *)HMACUsingSHA1_withSecretKey:(NSString *)secretKey
{
    ...
    CCHmac(kCCHmacAlgSHA1, [secretKey UTF8String], [secretKey length], [self bytes], [self length], &digest);
...
+ (id)dataWithBase64String:(NSString *)base64String
{
    ...
    CFRetain((__bridge CFTypeRef)(base64String));
    ...
    CFRelease((__bridge CFTypeRef)(base64String));
...
+ (id)dataWithBase16String:(NSString *)base16String
{
    ...
    CFRetain((__bridge CFTypeRef)(base16String));
    ...
    CFRelease((__bridge CFTypeRef)(base16String));
